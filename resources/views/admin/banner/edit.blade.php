...
@section('content')
<h2>Editar Banner <em>{{ $banner->nome }}</em></h2>
	    ...
	    <input name="_method" type="hidden" value="PUT">
			...
			<div class="row">
			    <div class="col-xs-12 col-sm-12 col-md-12">
			        ...
			        <input class="form-control" type="text" name="subtitle" value="{{ $banner->subtitle }}" placeholder="Legenda da Imagem" required="required">
			    </div>

			    <!-- <div class="col-xs-12 col-sm-12 col-md-12">
			        <label for="cnpj">Arquivo</label>
			        <input class="form-control" type="text" name="cnpj" value="{{ $banner->arquivo }}" placeholder="Arquivo">
			    </div> -->
            ...
            <div class="form-group boxTirarFoto">
              <h3>Enviar foto:</h3>
                ...
                <div class="box_img">
                  <img src="{{ url('/') }}/upload/banners/thumb/{{ $banner->image }}">
            ...
            <div class="form-group boxTirarFoto">
              <h3>Enviar foto Mobile: <span class="text-subtitle">(imagem ideal: 788x738 pixels)</span> </h3>
                ...
                <div class="box_img_mobile">
                  <img src="{{ url('/') }}/upload/banners-mobile/thumb/{{ $banner->image_mobile }}">
                  <input type='hidden' name='image_mobile' value="{{ $banner->image_mobile }}">
                </div>
                <div class="clear"></div>
            </div>
          </div>
