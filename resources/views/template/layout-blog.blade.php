...
<html lang="pt-br" class="no-js">
	<head>
		...
		<link href="{{ asset('assets/css/horizontal_timeline.2.0.min.css') }}" rel="stylesheet">
	...
	<body>
		...
		<script src="{{ asset('assets/js/topo.js/') }}" type="text/javascript"></script> -->
		...
		<script src="{{ asset('assets/js/horizontal_timeline.2.0.min.js') }}" type="text/javascript"></script>
