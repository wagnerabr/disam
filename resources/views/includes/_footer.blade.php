		...
		<div class="container containerP">
			<div class="row">
				...
				<div class="col-md-4 col-sm-4 col-xs-12 center-footer-xs">
					...
					<a href="#" class="midias-footer"><i class="fab fa-twitter"></i></a>
					<a href="#" class="midias-footer"><i class="fab fa-facebook-f"></i></a>
					<a href="#" class="midias-footer"><i class="fab fa-pinterest"></i></a>
				</div>
			</div>
		</div>
	</section>
