...
DEMO AND DOCUMENTATION: https://www.responsivefilemanager.com/
...
In order to work on assets, you need to install [Node.js](https://nodejs.org), [Bower](https://bower.io) and [gulp](https://gulpjs.com), then cd to your folder and run these commands:
...
Gulp use [laravel-elixir](https://laravel.com/docs/5.0/elixir)
### Credits

- [Bootstrap](https://twitter.github.io/bootstrap)
- [Bootstrap Lightbox](https://jbutz.github.io/bootstrap-lightbox)
- [Dropzonejs](https://www.dropzonejs.com)
- [Fancybox](https://fancybox.net)
- [TouchSwipe](https://labs.rampinteractive.co.uk/touchSwipe/demos)
- [PHP Image Magician](https://phpimagemagician.jarrodoberto.com)
- [Mini icons](https://www.fatcow.com/free-icons)
- [Jupload](https://jupload.sourceforge.net)
- [Bootbox](https://bootboxjs.com)
- [jQuery contextMenu](https://medialize.github.io/jQuery-contextMenu)
