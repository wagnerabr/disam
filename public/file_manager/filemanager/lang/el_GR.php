...
return array(
	...
	'Upload_java_help' => "Αν το Java Applet δεν φορτώνει, 1. Βεβαιωθείτε ότι έχετε εγκαταστημένη Java, αλλιώς <a href='https://java.com/en/download/'>[σύνδεσμος λήψης]</a>   2. βεβαιωθείτε ότι τίποτα δεν έχει αποκλειστεί από το τείχος προστασίας σας",
