 ...
 * 					are expecting then it might have been destroyed by PHP - c.f. https://bugs.php.net/bug.php?id=39693
 *
 */
...
class JUpload {
	...
	private function str_applet() {
		...
		$ret .= '  codebase = "https://java.sun.com/update/1.5.0/jinstall-1_5-windows-i586.cab#Version=5,0,0,3"'.$N;
		...
		foreach ($params as $key => $val)
		$ret .= '      '.$key.' = "'.$val.'"'.$N;
		$ret .= '      pluginspage = "https://java.sun.com/products/plugin/index.html#download">'.$N;
		$ret .= '      <noembed>'.$N;
